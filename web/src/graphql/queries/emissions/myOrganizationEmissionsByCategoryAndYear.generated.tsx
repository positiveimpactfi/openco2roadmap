...
export type MyOrganizationEmissionsByCategoryAndYearQuery = { __typename?: 'Query', myOrganizationEmissionsByCategoryAndYear: Array<{ __typename?: 'YearlyCalculationSummary', categoryid?: Types.Maybe<string>, yearlysums?: Types.Maybe<string> }> };
